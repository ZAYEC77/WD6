...
class File extends CActiveRecord
{
    ...
    {
        return Yii::app()->baseUrl."/".Yii::app()->params['uploadUrl'].$this->url;
    }
	...
	public function search()
	{
        ...
        if (!Yii::app()->user->isAdmin()) {
            $criteria->join = "INNER JOIN album ON album.id=albumId";
           // $criteria->compare('id', Yii::app()->user->getModel()->id);
        }
